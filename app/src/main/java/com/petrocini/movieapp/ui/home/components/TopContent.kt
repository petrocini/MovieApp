package com.petrocini.movieapp.ui.home.components
...
import com.petrocini.movieapp.R
import com.petrocini.movieapp.ui.home.defaultPadding
import com.petrocini.movieapp.ui.home.itemSpacing
...
fun TopContent(
    ...
    val imgRequest = ImageRequest.Builder(LocalContext.current)
        .data("${TmdbApiConstants.BASE_IMAGE_URL}${movie.posterPath}")
        .crossfade(true)
        .build()
    Box(
        modifier = modifier
